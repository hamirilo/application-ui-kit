/**
 * HamiriloTable - shared UI libraryのテーブルコンポーネント
 *
...
export interface HamiriloTableColumn<T> {
...
export interface HamiriloTableProps<T> {
  /** 列定義 */
  columns: HamiriloTableColumn<T>[];
 ...
 * ```
 */
export function HamiriloTable<T>({
  columns,
  rows,
  rowKey,
...
HamiriloTable.displayName = "HamiriloTable";
