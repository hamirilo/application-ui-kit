/**
 * HamiriloConfirmDialog - shared UI libraryの確認ダイアログコンポーネント
 *
 * 削除・編集・公開・アーカイブなど、ユーザーの操作確認が必要な場面で使用します。
 * HamiriloDialog をベースに、確認ダイアログ専用の Props を提供します。
 *
 * 画面側では HamiriloConfirmDialog のみを使用してください（HamiriloDialog を直接使わない）。
...
import { HamiriloDialog } from "./HamiriloDialog";

export interface HamiriloConfirmDialogProps {
  /**
   * ダイアログの開閉状態
   */
  open: boolean;
 ...
 * ```
 */
export const HamiriloConfirmDialog = ({
  open,
  onOpenChange,
  title,
  message,
