/**
 * HamiriloCheckbox - shared UI libraryのチェックボックス
 *
...
export interface HamiriloCheckboxProps
...
/**
 * HamiriloCheckbox コンポーネント
 *
 * @example
 * ```tsx
 * // 基本
 * <HamiriloCheckbox label="利用規約に同意する" />
 *
 * // 制御付き
 * <HamiriloCheckbox label="公開する" checked={open} onCheckedChange={setOpen} />
 *
 * // 説明付き
 * <HamiriloCheckbox
 *   label="メール通知を受け取る"
 ...
 *
 * // 全選択（一部選択状態）
 * <HamiriloCheckbox label="すべて選択" indeterminate={someSelected} />
 * ```
 */
export const HamiriloCheckbox = React.forwardRef<HTMLButtonElement, HamiriloCheckboxProps>(
...
HamiriloCheckbox.displayName = "HamiriloCheckbox";
