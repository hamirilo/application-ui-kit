/**
 * HamiriloBadge - shared UI libraryのバッジ（ステータス表示）コンポーネント
 *
...
export interface HamiriloBadgeProps
...
const TONE_CLASS: Record<HamiriloBadgeTone, string> = {
 ...
 *
 * // 一覧のステータス列
 * <HamiriloBadge tone={statusToneMap[row.status]}>{row.statusLabel}</HamiriloBadge>
 *
 * // アイコン付き
 * <HamiriloBadge tone="danger" icon={<AlertCircle className="h-3 w-3" />}>エラー</HamiriloBadge>
 * ```
 */
export const HamiriloBadge = React.forwardRef<HTMLSpanElement, HamiriloBadgeProps>(
...
HamiriloBadge.displayName = "HamiriloBadge";
