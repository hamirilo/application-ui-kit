...
import { HamiriloActiveIndicator } from "./HamiriloActiveIndicator";

export type HamiriloNavItemColor =
  | "primary"
  | "blue"
  | "indigo"
  | "teal"
...
interface HamiriloNavItemBaseProps {
  active?: boolean;
  icon?: ReactNode;
  label?: ReactNode;
  badge?: ReactNode;
  activeColor?: HamiriloNavItemColor;
  layoutId?: string;
  className?: string;
  children?: ReactNode;
}

export type HamiriloNavItemLinkProps = HamiriloNavItemBaseProps &
  Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, keyof HamiriloNavItemBaseProps> & {
    href: string;
  };

export type HamiriloNavItemButtonProps = HamiriloNavItemBaseProps &
  Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, keyof HamiriloNavItemBaseProps> & {
    href?: undefined;
  };

export type HamiriloNavItemProps = HamiriloNavItemLinkProps | HamiriloNavItemButtonProps;

const colorStyles: Record<
  HamiriloNavItemColor,
...
export const HamiriloNavItem = React.forwardRef<
  HTMLAnchorElement | HTMLButtonElement,
  HamiriloNavItemProps
>((props, ref) => {
  const {
    href,
    active = false,
  ...
  const innerContent = (
    <>
      ...
      {active && <HamiriloActiveIndicator layoutId={layoutId} className={currentStyle.indicator} />}
    </>
  );
...
HamiriloNavItem.displayName = "HamiriloNavItem";
