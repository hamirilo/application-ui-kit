/**
 * HamiriloFormDialog - shared UI libraryのフォームダイアログコンポーネント
 *
 * フォーム入力を含むダイアログで使用します。
 * HamiriloDialog をベースに、フォーム送信・バリデーション機能を提供します。
 */

import * as React from "react";
import { HamiriloDialog } from "./HamiriloDialog";

export interface HamiriloFormDialogProps {
  /**
   * ダイアログの開閉状態
   */
  open: boolean;
 ...
 * ```
 */
export const HamiriloFormDialog = ({
  open,
  onOpenChange,
  title,
  description,
