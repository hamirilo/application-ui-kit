/**
 * HamiriloPagination - shared UI libraryのページネーション
 *
 * HamiriloTable など一覧の下に置く。ページ番号は 1 始まり。
 *
 * <important>
...
export interface HamiriloPaginationProps {
  /** 現在のページ（1 始まり） */
  page: number;
...
/**
 * HamiriloPagination コンポーネント
 *
 * @example
 * ```tsx
 * <HamiriloPagination page={page} totalPages={12} onPageChange={setPage} />
 * ```
 */
export const HamiriloPagination = React.forwardRef<HTMLElement, HamiriloPaginationProps>(
...
HamiriloPagination.displayName = "HamiriloPagination";
