 ...
 *
 * 画面側では ApplicationDropdown のみを使用し、shadcn/ui の DropdownMenu を直接使用しないでください。
 */
...
export interface ApplicationDropdownProps {
  /**
   * メニューを開くトリガー要素（通常は ApplicationButton や IconButton）
   */
