...
import { ApplicationRadioTable } from "./ApplicationRadioTable";
import type { ApplicationTableColumn } from "./ApplicationTable";
...
function renderTable(
  props: Partial<React.ComponentProps<typeof ApplicationRadioTable<Plan>>> = {},
) {
  return render(
...
describe("ApplicationRadioTable", () => {
