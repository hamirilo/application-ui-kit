/**
 * ApplicationButtonGroup - shared UI libraryのボタングループ（ラジオボタンのボタン表現）
 *
...
export interface ApplicationButtonGroupProps {
  /** 選択肢 */
  items: ApplicationButtonGroupItem[];
 ...
 *
 * // 基本
 * <ApplicationButtonGroup items={items} defaultValue="day" aria-label="表示期間" />
 *
 * // 制御付き
 * <ApplicationButtonGroup items={items} value={period} onValueChange={setPeriod} aria-label="表示期間" />
 *
 * // アイコン付き
 ...
 * ```
 */
export const ApplicationButtonGroup = React.forwardRef<HTMLDivElement, ApplicationButtonGroupProps>(
  (
    {
      items,
      value,
...
ApplicationButtonGroup.displayName = "ApplicationButtonGroup";
