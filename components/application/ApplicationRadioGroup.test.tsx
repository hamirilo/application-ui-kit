...
import { ApplicationRadioGroup, type ApplicationRadioGroupItem } from "./ApplicationRadioGroup";
...
describe("ApplicationRadioGroup", () => {
  ...
  it("読み上げ名がラベルから付く", () => {
    render(<ApplicationRadioGroup items={SHIPPING} defaultValue="standard" />);
  ...
  it("同じ画面に name なしのグループが2つあっても id が衝突しない", () => {
    ...
    render(
      <>
        <ApplicationRadioGroup items={SHIPPING} defaultValue="standard" onValueChange={first} />
        <ApplicationRadioGroup items={SHIPPING} defaultValue="standard" onValueChange={second} />
      </>,
    );
  ...
  describe('variant="cards"', () => {
    ...
    it("meta と description を表示する", () => {
      render(<ApplicationRadioGroup variant="cards" items={SHIPPING} defaultValue="standard" />);
