 ...
 *       <ApplicationButton variant="secondary">アクション1</ApplicationButton>
 *       <ApplicationButton variant="primary">アクション2</ApplicationButton>
 *     </div>
 *   }
 * >
 *   <div>コンテンツ</div>
...
export const ApplicationDialog = ({
  ...
  const defaultFooter = (
    <>
      ...
      {confirmText && (
        <ApplicationButton variant={confirmVariant} onClick={onConfirm} loading={confirmLoading}>
          {confirmText}
        </ApplicationButton>
      )}
    </>
