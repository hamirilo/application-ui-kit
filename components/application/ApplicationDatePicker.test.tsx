...
describe("ApplicationDatePicker parsing functions", () => {
...
describe("ApplicationDatePicker Component", () => {
  it("キーボードで直接日付を入力して Enter を押すと onChange が呼ばれフォーマットされる", async () => {
    const onChange = vi.fn();
    render(<ApplicationDatePicker mode="single" onChange={onChange} placeholder="日付を選択" />);
  ...
  it("error が渡されたときは aria-invalid が付く", () => {
    render(<ApplicationDatePicker error placeholder="日付を選択" />);
