...
/**
 * ApplicationPagination コンポーネント
 *
 * @example
 * ```tsx
 * <ApplicationPagination page={page} totalPages={12} onPageChange={setPage} />
 * ```
 */
export const ApplicationPagination = React.forwardRef<HTMLElement, ApplicationPaginationProps>(
