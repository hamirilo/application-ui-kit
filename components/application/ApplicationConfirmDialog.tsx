 ...
 *
 * 画面側では ApplicationConfirmDialog のみを使用してください（ApplicationDialog を直接使わない）。
...
export interface ApplicationConfirmDialogProps {
  /**
   * ダイアログの開閉状態
   */
  open: boolean;
...
/**
 * ApplicationConfirmDialog コンポーネント
 *
 * @example
 * ```tsx
 ...
 * ```
 */
export const ApplicationConfirmDialog = ({
  open,
  onOpenChange,
  title,
  message,
