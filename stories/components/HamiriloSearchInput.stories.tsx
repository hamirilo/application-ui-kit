...
import { HamiriloSearchInput, HamiriloTable } from "../../components/hamirilo";

/**
 * HamiriloSearchInput は一覧・テーブルの上に置くフィルタ用検索欄。
 *
 * <important>
 ...
 */
const meta = {
  title: "Components/HamiriloSearchInput",
  component: HamiriloSearchInput,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
| 場面 | 代わりに使うもの |
|---|---|
| 選択肢から選ぶ絞り込み | \`HamiriloSelect\` |
| 社員・取引先など候補から選ぶ検索 | Tom Select（server-rendered application） / Autocomplete（React） |
...
} satisfies Meta<typeof HamiriloSearchInput>;
