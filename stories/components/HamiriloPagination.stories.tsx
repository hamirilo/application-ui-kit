...
import { HamiriloPagination, HamiriloTable } from "../../components/hamirilo";
 ...
 */
const meta = {
  title: "Components/HamiriloPagination",
  component: HamiriloPagination,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
- \`HamiriloTable\` の下（React application でのページング）
- 検索結果・履歴一覧の下
...
} satisfies Meta<typeof HamiriloPagination>;
...
export const Default: Story = {
  render: () => {
    ...
    return <HamiriloPagination page={page} totalPages={5} onPageChange={setPage} />;
  },
};
...
export const ManyPages: Story = {
  render: () => {
    ...
    return <HamiriloPagination page={page} totalPages={42} onPageChange={setPage} />;
  },
};
...
export const FirstPage: Story = {
  render: () => {
    const [page, setPage] = React.useState(1);
    return <HamiriloPagination page={page} totalPages={20} onPageChange={setPage} />;
  },
};
...
export const SinglePage: Story = {
  render: () => <HamiriloPagination page={1} totalPages={1} onPageChange={() => {}} />,
};

type Row = { id: number; name: string; amount: number };

/** HamiriloTable と組み合わせた実際の使い方。 */
    ...
    return (
      <div className="space-y-3">
        <HamiriloTable<Row>
          ...
          rowKey={(r) => r.id}
        />
        <HamiriloPagination page={page} totalPages={10} onPageChange={setPage} />
      </div>
    );
  },
};
