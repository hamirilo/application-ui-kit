...
import { HamiriloSidebarItem } from "../../components/hamirilo";

const meta = {
  title: "Components/HamiriloSidebarItem",
  component: HamiriloSidebarItem,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
} satisfies Meta<typeof HamiriloSidebarItem>;
