 ...
 */
const meta = {
  title: "Components/ApplicationCheckbox",
  component: ApplicationCheckbox,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
| 選択肢が多い（十数個以上） | \`ApplicationSelect\` か検索できる UI |
| 即座に設定が反映される ON/OFF | スイッチ（\`ApplicationSwitch\` は未提供。必要になったら追加する） |
...
} satisfies Meta<typeof ApplicationCheckbox>;
    ...
    return (
      <div className="max-w-md space-y-3">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-border pt-3">
          ...
          <ApplicationButton variant="primary" size="sm" disabled={selected.length === 0}>
            保存
          </ApplicationButton>
        </div>
      </div>
