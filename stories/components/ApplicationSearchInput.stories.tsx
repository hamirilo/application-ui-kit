 ...
 */
const meta = {
  title: "コンポーネント/ApplicationSearchInput",
...
| 社員・取引先など候補から選ぶ検索 | \`ApplicationCombobox\`（React） / ネイティブの \`<select>\`（テンプレート） |
...
} satisfies Meta<typeof ApplicationSearchInput>;
