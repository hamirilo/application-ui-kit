...
import { HamiriloCard, HamiriloTabs } from "../../components/hamirilo";

/**
 * HamiriloTabs は同一画面内で複数のビューを切り替えるためのコンポーネント。
 *
 * <important>
 ...
 */
const meta = {
  title: "Components/HamiriloTabs",
  component: HamiriloTabs,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
- 無効なタブは初期選択されない
- タブの数は画面幅に収まる程度（5〜6個まで）に留める。増える場合は \`HamiriloSelect\` に切り替える
        `,
      },
    },
  },
...
} satisfies Meta<typeof HamiriloTabs>;
  ...
  render: () => {
    ...
    return (
      <div className="space-y-3">
        <HamiriloTabs items={BASIC_ITEMS} value={value} onValueChange={setValue} />
...
/** HamiriloCard の中で使う実際の使い方。 */
export const WithCard: Story = {
  render: () => (
    <HamiriloCard title="申請 #1024">
      <HamiriloTabs items={BASIC_ITEMS} />
    </HamiriloCard>
  ),
};
