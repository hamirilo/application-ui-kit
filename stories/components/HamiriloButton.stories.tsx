...
import { HamiriloButton } from "../../components/hamirilo";

/**
 * HamiriloButton は画面上のあらゆるアクションに使う唯一のボタンコンポーネント。
 *
 * <important>
 ...
 */
const meta = {
  title: "Components/HamiriloButton",
  component: HamiriloButton,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
} satisfies Meta<typeof HamiriloButton>;
...
export const AllVariants: Story = {
  ...
  render: () => (
    <div className="flex flex-wrap gap-3">
      ...
      <HamiriloButton variant="success">承認</HamiriloButton>
      <HamiriloButton variant="ghost">詳細</HamiriloButton>
      <HamiriloButton variant="link">リンク</HamiriloButton>
    </div>
  ),
};
...
export const Sizes: Story = {
  ...
  render: () => (
    <div className="flex flex-wrap items-center gap-3">
      <HamiriloButton size="sm">Small</HamiriloButton>
      <HamiriloButton size="default">Default</HamiriloButton>
      <HamiriloButton size="lg">Large</HamiriloButton>
    </div>
  ),
};
  ...
  render: () => (
    <div className="max-w-md rounded-xl border border-border p-4">
      ...
      <div className="flex justify-end gap-2">
        <HamiriloButton variant="secondary">キャンセル</HamiriloButton>
        <HamiriloButton variant="danger" leftIcon={<Trash className="w-4 h-4" />}>
          削除する
        </HamiriloButton>
      </div>
    </div>
...
export const InToolbar: Story = {
  ...
  render: () => (
    <div className="flex items-center gap-2 rounded-lg border border-border p-2">
      <HamiriloButton size="sm" leftIcon={<Plus className="w-3.5 h-3.5" />}>
        新規
      </HamiriloButton>
      <HamiriloButton size="sm" variant="secondary" leftIcon={<Download className="w-3.5 h-3.5" />}>
        CSV 出力
      </HamiriloButton>
      <div className="flex-1" />
      <HamiriloButton size="sm" variant="ghost">
        絞り込み
      </HamiriloButton>
    </div>
  ),
