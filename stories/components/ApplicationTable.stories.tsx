 ...
 */
const meta = {
  title: "コンポーネント/ApplicationTable",
...
- モバイルでは列数を減らす検討をする（\`className\` に \`hidden md:table-cell\` を付ける）
  ...
  args: {
    columns: COLUMNS as ApplicationTableColumn<unknown>[],
    rows: ROWS,
    caption: "申請の一覧",
  },
} satisfies Meta<typeof ApplicationTable>;
...
export const RowClickable: Story = {
  args: {
    ...
    columns: [
      ...
      ...COLUMNS.slice(2),
    ] as ApplicationTableColumn<unknown>[],
    onRowClick: () => {},
  },
};
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <ApplicationButton variant="danger" size="sm" disabled={selected.length === 0}>
            一括削除
          </ApplicationButton>
        </div>
        <ApplicationTable<Request>
