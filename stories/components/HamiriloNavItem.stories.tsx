...
import { HamiriloNavItem } from "../../components/hamirilo/HamiriloNavItem";

const meta = {
  title: "Components/HamiriloNavItem",
  component: HamiriloNavItem,
  parameters: {
    layout: "padded",
    docs: {
      description: {
        component: `
**HamiriloNavItem** は、Framer Motion の Shared Layout アニメーション (\`HamiriloActiveIndicator\`) を内蔵した標準ナビゲーションコンポーネントです。
...
} satisfies Meta<typeof HamiriloNavItem>;
