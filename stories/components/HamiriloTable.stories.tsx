 ...
 */
const meta = {
  title: "Components/HamiriloTable",
  component: HamiriloTable,
  parameters: {
    layout: "padded",
    docs: {
      description: {
...
- モバイルでは列数を減らす検討をする（\`className\` に \`hidden md:table-cell\` を付ける）
  ...
  args: {
    columns: COLUMNS as HamiriloTableColumn<unknown>[],
    rows: ROWS,
    caption: "申請の一覧",
  },
} satisfies Meta<typeof HamiriloTable>;
...
export const RowClickable: Story = {
  args: {
    ...
    columns: [
      ...
      ...COLUMNS.slice(2),
    ] as HamiriloTableColumn<unknown>[],
    onRowClick: () => {},
  },
};
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <HamiriloButton variant="danger" size="sm" disabled={selected.length === 0}>
            一括削除
          </HamiriloButton>
        </div>
